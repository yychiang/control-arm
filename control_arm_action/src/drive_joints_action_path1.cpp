...
void waypoints_arm_goal(control_msgs::FollowJointTrajectoryGoal& goal)
{
  ...
  goal.trajectory.points[index].positions[1] = -1.0005;
  goal.trajectory.points[index].positions[2] = 0.249;
  goal.trajectory.points[index].positions[3] = 0.638;
  ...
  goal.trajectory.points[index].positions[2] = -0.4;
  ...
  for (int j = 0; j < 4; ++j)
  {
    goal.trajectory.points[index].velocities[j] = 4.0;
  }
  // To be reached 4 seconds after starting along the trajectory
  ...
  goal.trajectory.points[index].positions.resize(4);
  goal.trajectory.points[index].positions[0] = 0.0;
  goal.trajectory.points[index].positions[1] = -1.005;
  goal.trajectory.points[index].positions[2] = 0.249;
  goal.trajectory.points[index].positions[3] = 0.638;
  ...
  // To be reached 4 seconds after starting along the trajectory
  goal.trajectory.points[index].time_from_start = ros::Duration(5.5);
